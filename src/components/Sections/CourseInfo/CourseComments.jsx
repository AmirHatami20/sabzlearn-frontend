...
import {useGetComments} from "../../../hooks/react-query/comment.js";

function CourseComments({courseId}) {
    const {data: comments = [], isLoading} = useGetComments(courseId);
    ...
    return (<div className="space-y-4">
        {comments.map((comment) => {
            ...
            >
                        ...
                        <div className="flex flex-col gap-y-2">
                            <div className="flex items-center gap-x-1 ">
                                ...
                                <span className="font-dana-demiBold">
                                    | {comment.creator.role === "ADMIN" ? "مدرس" : "کاربر"}
                                </span>
                            </div>
                ...
                {comment.parentComment === null && Object.values(comment?.answerContent || {}).map((answer) => {
                    ...
                    >
                        ...
                        <div
                            ...
                            <div className="flex items-center gap-x-3.5">
                                <div
                                    className={`hidden sm:flex items-center justify-center w-15 h-15 border rounded-full relative ${answer?.creator.role === "ADMIN" ? "border-primary" : "border-slate-300 dark:border-white/10"}`}
                                >
                                    <img
                                        src={noProfile}
                                        alt="noProfile"
